...
class ExportResourceMappingConfigTest {
  ...
  void testThatMappingHasNoDuplicatedTemplate() {
    final File file = new File("src/main/groovy/customexport/gecco/crf/ExportResourceMappingConfig.json")
  ...
  void testThatEachMappingHasATemplateFile() {
    ...
    for (final String templateName : mappings.transformByTemplate) {
      File mappingFile = new File("src/main/groovy/customexport/gecco/crf/" + templateName + ".groovy")
  ...
  void testThatEachCrfTemplateFileHasAMapping() {
    ...
    final String[] templateNames = new File("src/main/groovy/customexport/gecco/crf/").list()
  ...
  void testThatEachLabVitalTemplateFileHasAMapping() {
    ...
    final String[] templateNames = new File("src/main/groovy/customexport/gecco/crf/labVital").list()

    final File file = new File("src/main/groovy/customexport/gecco/crf/labVital/ExportResourceMappingConfig.json")
    final def slurper = new JsonSlurper().parse(file)
    final def mappings = slurper.mappings
