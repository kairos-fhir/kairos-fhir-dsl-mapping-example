package customexport.hdrp.dbconnection
...
class DbConnectionTest extends AbstractDslBuilderTest {
  ...
  void testThatDbConnectionFindsGender() throws IOException {
    ...
    final FileInputStream is = new FileInputStream("src/main/groovy/customexport/cxx/custom/dbconnection/patient.groovy")
