package customexport.izi.frankfurt
...
class ConsentTest extends AbstractDslBuilderTest {
  ...
  void testThatConsentIsExported() {
    ...
    final FileInputStream is = new FileInputStream("src/main/groovy/customexport/izi/frankfurt/consent.groovy")
  ...
  static Map<String, Object> createTestData() {
    final FileInputStream is = new FileInputStream("src/test/resources/customexport/izi/frankfurt/testConsent.json")
