...
condition {
  ...
  final boolean hasRelevance = isCovid(diagnosisCode)
  if (hasRelevance) {

    id = "DiagnosisCovid/" + context.source[diagnosis().id()]
...
static boolean isCovid(final String icdCode) {
  return icdCode == "U07.1" //Regex specified in profile
}
