...
condition {
  ...
  final boolean hasRelevance = isDependence(diagnosisCode)
  if (hasRelevance) {

    id = "DependenceOnVentilator/" + context.source[diagnosis().id()]
...
static boolean isDependence(final String icdCode) {
  return icdCode == "Z99.1" //Regex specified in profile
}
