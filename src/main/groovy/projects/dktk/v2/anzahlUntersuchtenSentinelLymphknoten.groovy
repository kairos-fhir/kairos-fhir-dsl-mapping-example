 ...
 * Specified by https://simplifier.net/oncology/anzahluntersuchtensentinellymphknoten
 * @author Mike Wähnert
...
observation {
  ...
  def lflv = context.source[laborMapping().laborFinding().laborFindingLaborValues()].find { final lflv ->
    ...
    return laborValueCode.equalsIgnoreCase("Sentinel_LK_untersucht")
  }
  if (lflv == null) {
    return
  }
  ...
  meta {
    profile "http://dktk.dkfz.de/fhir/StructureDefinition/onco-core-Observation-AnzahlUntersuchtenSentinelLymphknoten"
  }
