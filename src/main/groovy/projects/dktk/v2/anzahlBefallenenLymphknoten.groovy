 ...
 * Specified by https://simplifier.net/oncology/anzahlbefallenenlymphknoten
 * @author Mike Wähnert
...
observation {
  ...
  meta {
    profile "http://dktk.dkfz.de/fhir/StructureDefinition/onco-core-Observation-AnzahlBefallenenLymphknoten"
  }
