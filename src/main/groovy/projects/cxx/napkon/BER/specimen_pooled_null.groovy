...
specimen {
    ...
    boolean containsOrgUnit = list.contains(context.source[sample().organisationUnit().code()] as String)
    ...
    // get Id
    String napkonId = sampleIdContainer?.getAt(SampleIdContainer.PSN) as String
