...
/**
 * Represents a HDRP LaborMapping for the US Core Vital Sign Observation Body Temperature.
...
observation {
  ...
  final def laborFindingLaborValue = context.source[laborMapping().laborFinding().laborFindingLaborValues()]
      .find { final lblv -> lblv[CRF_TEMPLATE_FIELD][CrfTemplateField.LABOR_VALUE][CODE] == "BODY_TEMPERATURE" }
