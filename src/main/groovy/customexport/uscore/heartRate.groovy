...
/**
 * Represents a HDRP LaborMapping for the US Core Vital Sign Observation Heart Rate.
...
observation {
  ...
  final def laborFindingLaborValue = context.source[laborMapping().laborFinding().laborFindingLaborValues()]
      .find { final lblv -> lblv[CRF_TEMPLATE_FIELD][CrfTemplateField.LABOR_VALUE][CODE] == "HEART_RATE" }
