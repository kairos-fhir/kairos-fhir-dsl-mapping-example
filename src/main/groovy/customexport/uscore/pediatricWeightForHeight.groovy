...
/**
 * Represents a HDRP LaborMapping for the US Core Vital Sign Observation Pediatric Weight for Height.
...
observation {
  ...
  final def laborFindingLaborValue = context.source[laborMapping().laborFinding().laborFindingLaborValues()]
      .find { final lblv -> lblv[CRF_TEMPLATE_FIELD][CrfTemplateField.LABOR_VALUE][CODE] == "PEDIATRIC_WEIGHT_FOR_HEIGHT" }
