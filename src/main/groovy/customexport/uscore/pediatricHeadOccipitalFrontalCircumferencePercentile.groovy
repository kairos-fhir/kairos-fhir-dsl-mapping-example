...
/**
 * Represents a HDRP LaborMapping for the US Core Vital Sign Observation Pediatric Head Occipital Frontal Circumference Percentile.
...
observation {
  ...
  final def laborFindingLaborValue = context.source[laborMapping().laborFinding().laborFindingLaborValues()]
      .find { final lblv -> lblv[CRF_TEMPLATE_FIELD][CrfTemplateField.LABOR_VALUE][CODE] == "PEDIATRIC_OCCIPITAL_FRONTAL_CIRCUMFERENCE_PERCENTILE" }
