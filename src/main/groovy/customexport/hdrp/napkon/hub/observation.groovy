package customexport.hdrp.napkon.hub
 ...
 * @since v.1.10.0, HDRP.v.3.18.2, HDRP.v.3.18.1.8
 *
 ...
 * defined with the same codes in both HDRP instances. In this case, only one mapping to the oid of the value list in the target system is required
 * for the import.
 */
observation {
