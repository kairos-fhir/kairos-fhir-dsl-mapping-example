 ...
 * Codings are custumized in HDRP. Therefore, the code system is unknown. In this example the usage of snomed-ct is assumed to be used.
 * If other codings are used in the local HDRP system, the code systems must be adjusted.
