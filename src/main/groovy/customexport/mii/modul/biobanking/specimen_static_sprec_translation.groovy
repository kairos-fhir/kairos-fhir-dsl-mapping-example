 ...
 * Codings are custumized in HDRP. Therefore, the code system is unknown. If other codings are used in the local HDRP system, the code systems must be adjusted.
