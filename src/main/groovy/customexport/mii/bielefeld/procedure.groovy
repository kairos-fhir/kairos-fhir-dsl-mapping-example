 ...
 * @since v.1.40.0, HDRP.v.2024.5.0, HDRP.v.2024.4.2
 * Requirements:
 * Custom Catalog for Procedure.status codes in HDRP featuring the FHIR valueset (http://hl7.org/fhir/ValueSet/event-status)
 * HDRP MeasurementProfile for called "ProcedureProfile" with parameters:
